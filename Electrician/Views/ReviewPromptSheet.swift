...
struct ReviewPromptSheet: View {
    ...
    private var navigationTitle: String {
        switch step {
        case .enjoyment: "Enjoying Electrician?"
    ...
    private var reviewPitchContent: some View {
        VStack(spacing: 18) {
            ...
            Text("Electrician is built by one person. No ads, no accounts, and your practice history never leaves your phone.")
                ...
                .multilineTextAlignment(.center)
                .fixedSize(horizontal: false, vertical: true)
            Text("An honest App Store review takes a few seconds and is the single biggest thing that helps a small app like this reach other electricians.")
                .font(.footnote)
                .foregroundStyle(Theme.inkSecondary)
                .multilineTextAlignment(.center)
                .fixedSize(horizontal: false, vertical: true)
    ...
    static func feedbackMailURL(body: String) -> URL? {
        ...
        components.queryItems = [
            URLQueryItem(name: "subject", value: "Electrician feedback"),
