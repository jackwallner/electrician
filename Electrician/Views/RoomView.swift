...
/// One room, its drills. Free drills open; Electrician+ extra sets show the lock and
...
struct RoomView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showPaywall) { PaywallView(source: "electrician_room_sheet") }
    }
    ...
    private var upsell: some View {
        Button {
            ...
            VStack(spacing: 8) {
                ...
                Text("\(Membership.name) unlocks the extra sets here and in every other room, the worked calculations, Code Minute, Exam Warm-Up, and Endless Practice. Everything you already have stays free.")
                    .font(.caption)
                    .foregroundStyle(Theme.inkSecondary)
                    .multilineTextAlignment(.leading)
    ...
    private func destination(_ drill: Drill) -> some View {
        ...
        case .calc(let scenarios):
            CalcDrillView(drill: drill, scenarios: scenarios)
        }
    }
}
