...
enum Theme {
    ...
    /// Serif display for titles — the "electrician club" voice.
...
extension Room {
    var accent: Color {
        switch id {
        case "basics-room": return Theme.jade
        case "conductors-room": return Theme.coral
        case "calc-room": return Theme.plum
