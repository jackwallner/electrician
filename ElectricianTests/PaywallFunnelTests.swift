...
final class PaywallFunnelTests: XCTestCase {
    ...
    func testCountsPitchesPerSurfaceAndInTotal() {
        ConversionDiagnostics.recordPitchView(impressionID: "electrician_home_sheet")
        ConversionDiagnostics.recordPitchView(impressionID: "electrician_home_sheet")
        ConversionDiagnostics.recordPitchView(impressionID: "electrician_onboarding_fallback")
        ...
        XCTAssertEqual(attributes["pitch_last"], "onboarding_fallback")
    }
    ...
    func testConversionFreezesTheSurfaceAndCountAtTheMomentOfSale() {
        ...
        let attributes = ConversionDiagnostics.subscriberAttributes
        XCTAssertEqual(attributes["converted_surface"], "onboarding_fallback")
    ...
    func testAttributeKeysStayInsideRevenueCatsLimit() {
        ...
        ConversionDiagnostics.recordPitchView(impressionID: "electrician_\(long)")
