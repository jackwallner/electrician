...
enum RevenueCatProbe {
    ...
    static let testStoreKey = "test_jeolotJYrvsaAIHEhaAlDjRPJMl"

    static var appUserID: String {
        ProcessInfo.processInfo.environment["RC_PROBE_USER"] ?? "funnel-probe-electrician"
    }

    static var impressionID: String {
        ProcessInfo.processInfo.environment["RC_PROBE_SURFACE"] ?? "electrician_home_sheet"
    }
}
#endif
