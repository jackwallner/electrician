...
/// On-device record of how someone met Electrician+ before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.electrician", category: "Conversion")
    ...
    private static let impressionPrefix = "electrician_"
